...
\copy company_dim FROM 'Path-To-Your-CSV' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_dim FROM 'Path-To-Your-CSV' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy job_postings_fact FROM 'Path-To-Your-CSV' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');

\copy skills_job_dim FROM 'Path-To-Your-CSV' WITH (FORMAT csv, HEADER true, DELIMITER ',', ENCODING 'UTF8');
